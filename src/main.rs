...
async fn main() -> Result<()> {
    ...
    //                     // 2. 发送初始握手包
    //                     common_buffer = handshake.init_plain_packet();
    ...
    //                             let (valid_pass, data) =
    //                                 match handshake.auth_with_response(&mut common_buffer) {
    //                                     Ok(buf) => buf,
    //                                     Err(e) => {
    //                                         println!("{e}");
    //                                         break;
    ...
    //                             if valid_pass {
    //                                 sql_command
    //                                     .set_client_capabilities(*handshake.client_capabilities());
    ...
    //                             let mut bufs = sql_command.read(&mut common_buffer).unwrap();
